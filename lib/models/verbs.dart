...
class _MyVerbsState extends State<MyVerbs> {
  ...
  void loadData() async {
    ...
    for (String line in lines) {
      ...
      // Convert the line to a list of values and add to csvTable
  ...
  void selectRandomVerb() {
    ...
    print("random row index = $randomRowIndex");
    print("data length =");
    print(_data.length);
    print(_data);
    print(_data[randomRowIndex]);
  ...
  void handleUserInput(String input) {
    ...
    if (correctAnswer.contains("(zijn)")) {
      correctAnswer = correctAnswer.replaceAll("(zijn) ", "");
    }
    ...
    switch (whichCase) {
            ...
            Container(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  gradient: solutionGiven
                      ? isCorrect
                          ? kPrimaryGradient2
                          : kPrimaryGradient3
                      : kPrimaryGradient, // Apply the gradient background
                  borderRadius: BorderRadius.circular(
                      10), // Apply the gradient background
                ),
                child: Row(
      ...
      default:
        return const SizedBox
            .shrink(); // Return an empty widget for unknown cases
    }
  }
